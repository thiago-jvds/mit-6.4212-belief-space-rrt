...
class RRBT_MustardPositionBelief_Tree:
    """
    Rapidly-exploring Random Belief Tree for mustard position estimation.
    ...
    Args:
        problem: IiwaProblemMustardPositionBelief instance
        root_value: Starting configuration
